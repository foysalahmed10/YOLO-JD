...
## Acknowledgement
Part of our code was descended and modified from the open-source code by ultralytics. Their original code can be found at: [ https://github.com/PRBonn/4d_plant_registration](https://github.com/ultralytics/yolov5.git).
